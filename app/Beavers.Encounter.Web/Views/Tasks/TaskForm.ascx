...
<% using (Html.BeginForm()) { %>
    ...
    <ul>
		...
		<li>
			...
			при этом одновременно данное задание потенциально смогут выполнять 3-4 команды.
			При приоритете 150 одновременно задание потенциально могут выполнять 4-5 команд.
