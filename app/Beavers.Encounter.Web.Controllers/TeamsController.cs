...
namespace Beavers.Encounter.Web.Controllers
{
    ...
    public class TeamsController : BaseController
    {
        ...
        public ActionResult Create([TeamBinder(Fetch = false)]Team team)
        {
            ...
            {
                // јвторы могут создавать команды, но не бедут €вл€тьс€ членами созданной команды
                if (!User.Role.IsAuthor)
                {
                    // ƒелаем текущего пользовател€ капитаном созданной команды
                    team.TeamLeader = User;

                    // ƒелаем текущего пользовател€ членом созданной команды
                    User.Team = team;
                }
        ...
        public ActionResult SingIn(int id, string accessKey)
        {
            ...
            if (team.AccessKey == accessKey)
            {
                ...
                // ѕервого игрока вошедшего в команду делаем капитаном команды
        ...
        public ActionResult SingOut()
        {
            ...
            // ≈сли игрок был капитаном, то анулируем его капитанство
            ...
            // ≈сли команда осталась без капитана, 
            // то делаем первого пользовател€ из списка членов команды капитаном
